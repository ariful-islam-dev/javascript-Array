...
//Array of Objects
const favChannels = [
  { name: "Stack Learner", url: "hppps://youtube.com/stacklearner" },
  { name: "JS Bangladesh", url: "https://youtube.com/jsbangladesh" },
  { name: "Travesy Media", url: "https:/youtube.com/techguyweb" },
...
//Array of Arrays -multim Dimensional Array
...
//One Dimensinal Traverse
for (let i = 0; i < pointTable.length; i++) {
  // console.log(`Poin ${i} -x=${pointTable[i][0]} and y=${[pointTable[i][1]]}`);
}
